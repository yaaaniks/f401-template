...
# SRC+=$(CORE_DIR)/rcc.c
# # SRC_FILES = $(wildcard $(SOURCE_DIR)*.c) $(wildcart $(SOURCE_DIR)*/*.c)
# # ASM_FILES = $(wildcard $(CPU_DIR)*.s) $(wildcart $(CPU_DIR)*/*.s)
# # CORE_FILES = $(wildcard $(CORE_DIR)*.c) $(wildcart $(CORE_DIR)*/*.c)
# ###################################################
...
SRC=$(SOURCE_DIR)/main.c 
SRC+=$(SOURCE_DIR)/system_stm32f4xx.c
SRC+=$(CORE_DIR)/timer.c $(CORE_DIR)/rcc.c $(CORE_DIR)/gpio.c
